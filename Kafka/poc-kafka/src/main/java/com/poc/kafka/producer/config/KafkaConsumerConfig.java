...
public class KafkaConsumerConfig {
	...
	public ConsumerFactory<String, EventData> consumerFactory() {
		...
		return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(EventData.class));
	}

	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, EventData> kafkaListenerContainerFactory() {

		ConcurrentKafkaListenerContainerFactory<String, EventData> factory = new ConcurrentKafkaListenerContainerFactory<>();
